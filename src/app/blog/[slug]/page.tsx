      ...
      <article>
        <div className="relative h-[40vh] min-h-[280px]">
          ...
          <div className="container-custom relative z-10 h-full flex flex-col justify-end pb-10">
            <Link href="/blog" className="inline-flex items-center gap-2 text-sm text-navy-200 hover:text-white mb-4">
              <ArrowLeft className="h-4 w-4" /> Retour au blog
            </Link>
            <div className="flex gap-4 text-xs text-navy-300 mb-3">
              <span className="font-bold text-brand-400">{post.category}</span>
        ...
        <div className="section-padding">
          <div className="container-custom max-w-3xl" dangerouslySetInnerHTML={{ __html: contentHtml }} />
        </div>
      </article>
