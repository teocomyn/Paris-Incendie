      ...
      <section className="section-padding">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto prose-custom space-y-8">
            <div>
              <h2 className="text-2xl font-bold text-navy-900 mb-4">1. Informations légales</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-navy-900 mb-4">2. Hébergeur</h2>
              <p className="text-navy-600 leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold text-navy-900 mb-4">3. Propriété intellectuelle</h2>
              <p className="text-navy-600 leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold text-navy-900 mb-4">4. Données personnelles</h2>
              <p className="text-navy-600 leading-relaxed">
