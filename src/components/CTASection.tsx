        ...
        <div className="glass-panel relative overflow-hidden min-h-[320px] flex items-center">
          {showImage && (
            <>
              ...
              <div className="glow-orb glow-orb-flame w-[400px] h-[300px] bottom-0 right-0 opacity-50" />
              <div className="grain-overlay" />
            </>
          )}
          <div className="relative z-10 grid md:grid-cols-2 gap-8 items-center p-8 md:p-12 lg:p-16 w-full">
            <div>
              <p className="glass-pill inline-block text-[11px] font-bold uppercase tracking-[0.2em] text-brand-500 mb-4 px-3 py-1">
                Devis gratuit
              </p>
